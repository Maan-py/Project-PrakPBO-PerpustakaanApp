 ...
 * @author Maan
 */
public class RiwayatPeminjamanPage extends javax.swing.JFrame {
...
//        jLink_CoverField.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RiwayatPeminjamanPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RiwayatPeminjamanPage().setVisible(true);
            }
        });
    }
